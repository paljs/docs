...
[![Version](https://img.shields.io/npm/v/@paljs/ui.svg)](https://npmjs.org/package/@paljs/ui)
[![Downloads/total](https://img.shields.io/npm/dt/@paljs/ui.svg)](https://npmjs.org/package/@paljs/ui)
[![License](https://img.shields.io/npm/l/@paljs/ui.svg)](https://paljs.com/)
...
[![Version](https://img.shields.io/npm/v/@paljs/icons.svg)](https://npmjs.org/package/@paljs/icons)
[![Downloads/total](https://img.shields.io/npm/dt/@paljs/icons.svg)](https://npmjs.org/package/@paljs/icons)
[![License](https://img.shields.io/npm/l/@paljs/icons.svg)](https://paljs.com/)

- This is icons package passed on [eva-icon](https://akveo.github.io/eva-icons/) package.

- [gatsby-admin-template](https://github.com/paljs/gatsby-admin-template) - Admin dashboard template based on Gatsby.Js with `@paljs/ui` component package.
- [nextjs-admin-template](https://github.com/paljs/nextjs-admin-template) - Admin dashboard template based on Next.Js with `@paljs/ui` component package.
