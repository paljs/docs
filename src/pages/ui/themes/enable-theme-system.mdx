...
> Note: If you use our [gatsby-admin-template kit](/ui/guides/install-based-on-starter-kit) then you already have the Advanced setup in place.

> Note: If you use our [Starter project](/ui/guides/start-new-project) then you already have the Normal setup in place.
...
import { Layout, createTheme } from '@paljs/ui';
