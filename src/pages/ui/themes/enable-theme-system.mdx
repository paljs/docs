...
> Note: If you use our [gatsby-admin-template kit](/ui/guides/start-from-gatsby-template) or [nextjs-admin-template kit](/ui/guides/start-from-nextjs-template) then you already have the Advanced setup in place.
